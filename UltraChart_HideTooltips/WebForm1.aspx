<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="UltraChart_HideTooltips.WebForm1" %>

<%@ Register Assembly="Infragistics45.WebUI.UltraWebChart.v22.1, Version=22.1.20221.20, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb" Namespace="Infragistics.WebUI.UltraWebChart" TagPrefix="igchart" %>

<%@ Register assembly="Infragistics45.WebUI.UltraWebChart.v22.1, Version=22.1.20221.20, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb" namespace="Infragistics.UltraChart.Resources.Appearance" tagprefix="igchartprop" %>
<%@ Register assembly="Infragistics45.WebUI.UltraWebChart.v22.1, Version=22.1.20221.20, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb" namespace="Infragistics.UltraChart.Data" tagprefix="igchartdata" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="利用可能なデータがありません。 Data.DataSource に有効なデータソースを設定した後、UltraChart.Data.DataBind() を呼び出してください。" Version="22.1">
            <Effects>
                <Effects>
